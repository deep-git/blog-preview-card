  ...
  return (
    <div className="bg-flat-yellow min-h-screen flex justify-center items-center">
      <main className="w-80 font-figtree p-6 flex flex-col bg-white rounded-2xl border-2 border-black shadow-[5px_5px_0px_rgba(0,0,0,0.9)] md:w-96">
        <img src="illustration-article.svg" className="rounded-xl" alt="Illustration article"/>
        ...
        <h1 className="mt-3 text-xl font-extrabold md:text-2xl">HTML & CSS foundations</h1>
        ...
        <div className="flex items-center mt-5">
          <img src="image-avatar.webp" className="w-9 h-9 rounded-full" alt="Image avatar"/>
